					...
					<div class="dd" id="nestable">
						...
						<?php							
							...
							foreach ($kategori as $data) {
								...
								$thisRef = &$ref[$data->id_cat];
								
								$thisRef['idparent'] = $data->id_parent;
								$thisRef['nama_menu'] = $data->nama_kategori;
								$thisRef['link'] = $data->kategori_seo;
								$thisRef['class'] = $data->css_class;
								$thisRef['idmenu'] = $data->id_cat;
								
								if($data->id_parent == 0) {
									$items[$data->id_cat] = &$thisRef;
									} else {
									$ref[$data->id_parent]['child'][$data->id_cat] = &$thisRef;
								}
...
<script src="<?= base_url('assets/backend/dist/'); ?>js/kategori.js" type="text/javascript"></script>