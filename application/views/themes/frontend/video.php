                ...
                <div>
                    <div style="top: 0px; left: 0px; width: 1064px; height: 500px; position: absolute; display: block; overflow: hidden; background-color:#000; background-image: none;">
                        ...
                        <div class="title-big_slider" style="color:#fff;">
                            ...
                            <div class="playin">
                                <a href="<?=base_url('detail/').$row['judul_seo'];?>"><i class="fa fa-play"></i> &nbsp;WATCH VIDEO</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<section id="section-1" class="clearfix">
    ...
    <div class="col w-30" style="float:left !important;">
        <div class="col w-100" style="background:#EDEDED;float:left !important;border-radius:10px">
            <section id="update" class="list list-type-1" style="margin-bottom:15px;padding:0 10px">
                <div class="wrapper">
                    <a href="#" class="box-title red-500" style="position:relative;top:-15px;z-index: 2;border-radius:10px;font-size:12pt">
                    VIDEO</a>
    ...
    <div class="col w-70" style="float:right !important;">
        <div class="col w-60" style="float:left !important;background:#EDEDED;border-radius: 10px;padding:10px;margin-bottom:10px">
            ...
            <a href="#" class="box-title red-500" style="border-radius:10px;position:relative;top:17px;left:20px;">Artikel</a>
            <nav class="border">
                            ...
                            <?php 
                                ...
                                foreach($program AS $row){
                                    ...
                                    <li>
                                        <div class="card card-type-1 ">
                                            <div class="wrapper clearfix">
                                                <a class="col berita-pilihan" href="<?=base_url('detail/').$row['judul_seo'];?>" style="background: #eee">
                                                    <img loading="lazy" src="<?=$gambar;?>" alt="<?=$row['judul'];?>" width="354">
                                                </a>
                                                <a class="col berita-pilihan" href="<?=base_url('detail/').$row['judul_seo'];?>">
                                                    <h2 class="title"><?=$row['judul'];?></h2>
                                                </a>
                                                <a class="col berita-pilihan" href="<?=base_url('detail/').$row['judul_seo'];?>">
