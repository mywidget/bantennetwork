            ...
            <?php
                ...
                <div>
                    <div style="top: 0px; left: 0px; width: 1064px; height: 500px; position: absolute; display: block; overflow: hidden; background-color:#000; background-image: none;">
                        <img data-u="image" src="<?=$gambar;?>" alt="<?=$row['judul'];?>" class="lazy" data-src="<?=$gambar;?>" style="top: 0px; left: 0px; width: 1300px; height: 670px; position: absolute; display: block; max-width: 10000px; z-index: 1;" data-events="auto" data-display="block" border="0"></div><div style="top: 0px; left: 0px; width: 1300px; height: 670px; position: absolute; display: block; transform-style: preserve-3d; z-index: 1;" data-events="auto" data-display="block">
                        <a href="<?=base_url('detail/').$row['judul_seo'];?>">
    ...
    <div class="col w-30" style="float:left !important;">
        <div class="col w-100" style="background:#EDEDED;float:left !important;border-radius:10px;">
            <section id="update" class="list list-type-1" style="margin-bottom:15px;padding:0 10px;">
                <a href="#" class="box-title blue-500" style="position:relative;top:-15px;z-index: 1;border-radius:5px;margin:0 auto;">Berita terbaru</a>
                <div class="wrapper" style="max-height:1555px;overflow:auto">
                    <div class="postList">
    ...
    <div class="col w-70" style="float:right !important;">
        <div class="col w-60" style="float:left !important;background:#EDEDED;border-radius: 10px;padding:10px;margin-bottom:10px">
            <section id="berita-pilihan" class="berita-pilihan">
                <a href="/sorotan" class="box-title blue-500 populer h-25 ww-100" style="margin-left:20px">
                    SOROTAN
                </a>
            ...
            <section id="berita-pilihan" class="berita-pilihan">
                <a href="/populer" class="box-title blue-500 populer h-25" style="margin-left:20px;width:100px">
                    POPULER
                </a>
        ...
        <div class="col w-30" style="float:right !important;">
            <div class="ads rectangle">
                <div class="wrapper">	
                    <div id="mr_3" class="rectangle-ads" style="width:250px!important;height:auto;text-align: center;">
                        <?php echo iklan(['status'=>'home','id'=>1]);?>
                    </div>
                </div>
            </div>
        </div>
        <div class="col w-100" style="background:#fff;margin-top:0;border-bottom:3px solid #000">
            <a href="#" class="box-title red-500" style="border-radius:5px;position:relative;top:18px;left:20px">Artikel</a>
            <nav class="border">
            ...
            <div class="col w-50" style="float:left !important;margin-top:20px;border-right:3px solid #000;margin-bottom:10px;">
                <section id="update" class="list list-type-1">
                    <div class="wrapper" style="padding:0!important">
                        ...
                        <?php endforeach; ?>
                        <div class="cor w-30" style="margin-right:20px">
                            <h5 style="font-size:10px;text-align:center;background:#ff0000;border-radius:10px;color:#fff;padding:5px"><a href="/artikel">ARTIKEL LAINNYA</a></h5>
                        </div>
                    </div>
                </section>
            </div>
            <div class="col w-45" style="float:right !important;">
                <section id="berita-video" class="berita-pilihan" style="background:url('assets/frontend/images/bg.jpg') #660000;padding:10px;color:#fff;margin:20px 0 20px 0;">
                    <a href="#" class="box-title putih-500 populer tengah" style="border-radius:8px;position:relative;top:10px;margin-top:-10px;width:110px !important;height:20px !important;vertical-align: middle;line-height:20px">editor choice</a>
                    <div class="row clearfix">
                        <?php 
                        ...
                        <li class="col w-100" style="position:relative">
                            <div class="card card-type-4 putih">
                                <div class="wrapper clearfix" style="padding:5px;">
                                    <a class="col populer"  href="/detail/<?=$row['judul_seo'];?>">
                                        <img class="bayangan" loading="lazy" src="<?=$gambar;?>" alt="<?=$row['judul'];?>" width="400" style="border-radius:10px">
                                    </a>
                                    <a class="col populer" href="/detail/<?=$row['judul_seo'];?>">
        ...
        <div class="col w-100" style="background:#fff;margin-top:20px;">
            ...
            <section id="berita-video" class="berita-pilihan" style="background:url('assets/frontend/images/bg.jpg') #660000;padding:10px;color:#fff;border-radius:10px;margin:0 0 20px 0">
                <a href="/video" class="box-title putih-500 populer" style="width:60px !important;height:20px !important;line-height:20px">
                    video
                </a>
                <div class="row clearfix" style="overflow:hidden">
                    ...
                    ?>
                    <li class="col w-25" style="position:relative;">
                        <div class="card card-type-4 putih">
                            <div class="wrapper clearfix" style="padding:5px">
                                <a class="col populer" href="/detail/<?=$row['judul_seo'];?>">
                                    <img class="bayangan" loading="lazy" src="<?=$gambar;?>" alt="<?=$row['judul'];?>" width="400" style="border-radius:10px;">
                                </a>
                                <a class="col" style="margin-top:10px" href="/detail/<?=$row['judul_seo'];?>">
                                    <h6 class="title" style="margin-top:5px !important"><?=tgl_tiket($row['tanggal'],true,true);?> | <?=$row['dibaca'];?></h6>
                                </a>
                                <a class="col populer" href="/detail/<?=$row['judul_seo'];?>">
                                    <h2 class="title"><?=kata($row['judul'],50);?></h2>
                                </a>
                            </div>
                        </div>
                    </li>
                    <?php endforeach; ?>
                    <div class="cor w-15">
                        <h5 style="font-size:10px;text-align:center;background:#fff;border-radius:10px;color:#000;padding:0 5px"><a href="/video">VIDEO LAINNYA</a></h5>
                    </div>
                </div>
                
            </section>
            <section id="tabs popular" class="tab tab-type-1 terpopuler  " style="border:3px solid #000040;border-radius:10px;padding:10px">
                <a href="/program" class="col box-title red-500 berita-pilihan" style="width:100px !important;height:20px !important;line-height:20px;margin-left:20px">PROGRAM</a>
                <nav class="tab-pagination program" style="height:20px">
                    <div class="col w-70">
                ...
                <div class="cor w-25">
                    <h5 class="lainnya"><a href="/program">PROGRAM SELANJUTNYA</a></h5>
                </div>  
                <br>
            </section>
        </div>
