<?php
    ...
    class Akun extends CI_Controller
    {
        ...
        public function pembelian()
        {
            ...
            $config['base_url']    = base_url('akun/ajaxPembelian');
            ...
            $data['posts'] = $this->model_data->getPembelian($conditions);
            
            $this->template->load(backend() . '/themes', backend() . '/pembelian', $data);
        }
        function ajaxPembelian()
        {
            ...
            $this->load->view(backend() . '/ajax/ajax-pembelian', $data, false);
        }
