<?php if(! defined('BASEPATH')) exit ('no direct access allowed');
    ...
    class Backupdb extends CI_controller{
        ...
        public function list_data()
		{
            ...
            $fetch_data = directory_map('./backup_db/',1); 
            $data = array();  
            $no=1;
            ...
            {  
                ...
                if($exp[1]==date('Y-m-d')){
                    $btn = '<a href="/backupdb/download_db/'.$row.'" class="btn btn-success btn-sm" data-toggle="tooltip" title="Download"><i class="fa fa-download"></i></a> '.$archive;
                    }else{
                    $btn = '<a href="/backupdb/download_db/'.$row.'" class="btn btn-info btn-sm" data-toggle="tooltip" title="Download"><i class="fa fa-download"></i></a> '.$archive;
                }
        ...
        public  function download_db($file){
            $path = FCPATH.'backup_db/'.$file;
