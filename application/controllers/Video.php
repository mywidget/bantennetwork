<?php
	...
	class Video extends CI_Controller {
		...
		{
			$data['title'] = 'Video | lenternews.tv';
            ...
            "@type" =>  "Organization",
            "name" =>  "Lentera News",
            "url" =>  "https://www.lenternews.tv/video",
            "sameAs" => [
			...
			if($qry->num_rows()){
				...
				$data['terbaru'] =  $this->model_app->view_join_where('posting','cat','id_cat',['TIME(durasi)!='=>'00:00:00'],'tanggal','desc',8);
				...
				$config['base_url']    = base_url('video/Pagination/'); 
				...
				//end
				$this->template->load(template().'/themes',template().'/video',$data);
				}else{
				$data = error_page();
