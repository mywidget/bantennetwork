...
jQuery.extend(jQuery.easing, {
	...
	easeInOutElastic: function(a, b, c, d, f) {
		...
		e || (e = .3 * f * 1.5);
		l < Math.abs(d) ? (l = d, a = e / 4) : a = e / (2 * Math.PI) * Math.asin(d / l);
		return 1 > b ? -.5 * l * Math.pow(2, 10 * --b) * Math.sin(2 * (b * f - a) * Math.PI / e) + c : .5 * l * Math.pow(2, -10 * --b) * Math.sin(2 * (b * f - a) * Math.PI / e) + d + c
	},
...
(function(a) {
	var b = 0,
		...
		m = {
			...
			hideScrollbar: function(a, b, c, d, f, e, g, l, r, u) {
				if (a.scrollbar && a.scrollbarHide)
					for (var h = c; h < c + 25; h++) b[b.length] = m.hideScrollbarIntervalTimer(10 * h, d[c], (c + 24 - h) / 24, f, e, g, l, r, u, a)
			},
			hideScrollbarInterval: function(b, c, d, e, g, k, l, r, u) {
				f = -1 * b / A[r] * (g - k - l - e);
			...
			slowScrollHorizontalInterval: function(b, c, d, e, g, k, l, r, u, y, I, O, S, v, B, q, x, n, H) {
				if (H.infiniteSlider) {
					if (d <= -1 * A[q] || d <= -1 * ba[q]) {
						var h = a(b).width();
						if (d <= -1 * ba[q]) {
						...
						for (; d <= -1 * A[q];) {
							var t = 0,
								K = m.getSliderOffset(a(c[0]), "x");
							a(c).each(function(a) {
								m.getSliderOffset(this, "x") < K && (K = m.getSliderOffset(this, "x"), t = a)
							});
							S = p[q] + h;
							m.setSliderOffset(a(c)[t], S);
							p[q] = -1 * O[1] + x;
							A[q] = p[q] + h - k;
							O.splice(0, 1);
							O.splice(O.length, 0, -1 * S + x);
							G[q]++
						}
					}
					if (d >= -1 * p[q] || 0 <= d) {
						h = a(b).width();
						if (0 < d)
							for (D = -1 * I[0], a(c).each(function(b) {
									m.setSliderOffset(a(c)[b], D + x);
									b < O.length && (O[b] = -1 * D);
									D += B[b]
								}), d -= -1 * O[0], p[q] = -1 * O[0] + x, A[q] = p[q] + h - k, G[q] = v; 0 < -1 * O[0] - h + x;) {
								var z = 0,
									N = m.getSliderOffset(a(c[0]), "x");
								a(c).each(function(a) {
									m.getSliderOffset(this, "x") > N && (N = m.getSliderOffset(this, "x"), z = a)
								});
								S = p[q] - B[z];
								m.setSliderOffset(a(c)[z], S);
								O.splice(0, 0, -1 * S + x);
						...
						for (; d > -1 * p[q];) z = 0, N = m.getSliderOffset(a(c[0]), "x"), a(c).each(function(a) {
								m.getSliderOffset(this, "x") > N && (N = m.getSliderOffset(this, "x"), z = a)
							}), S = p[q] - B[z], m.setSliderOffset(a(c)[z], S), O.splice(0, 0, -1 * S + x), O.splice(O.length - 1, 1),
							p[q] = -1 * O[0] + x, A[q] = p[q] + h - k, G[q]--
					}
				}
				I = !1;
				k = m.calcActiveOffset(H, d, O, k, G[q], v, y, q);
				S = (k + G[q] + v) % v;
				H.infiniteSlider ? S != aa[q] && (I = !0) : k != F[q] && (I = !0);
				if (I && (v = new m.args("change", H, b, a(b).children(":eq(" + S + ")"), S, n), a(b).parent().data("args", v), "" != H.onSlideChange)) H.onSlideChange(v);
				F[q] = k;
				aa[q] = S;
				d = Math.floor(d);
				if (q != a(b).parent().data("args").data.sliderNumber) return !0;
				m.setSliderOffset(b, d);
				H.scrollbar && (f = Math.floor((-1 * d - p[q] + x) / (A[q] - p[q] + x) * (l - r - g)), b = g - u, d >= -1 * p[q] + x ? (b = g - u - -1 * f, m.setSliderOffset(a("." + e), 0)) : (d <= -1 * A[q] + 1 && (b = l - r - u - f), m.setSliderOffset(a("." + e), f)), a("." + e).css({
					width: b + "px"
				}))
			},
			slowScrollHorizontal: function(b, c, d, f, e, k, g, l, r, u, x, O, y, v, B, q, C, n, H, L, Q) {
				...
				e > Q.snapVelocityThreshold && Q.snapToChildren && !H ? D = 1 : e < -1 * Q.snapVelocityThreshold && Q.snapToChildren && !H && (D = -1);
				e < -1 * t ? e = -1 * t : e > t && (e = t);
				a(b)[0] !== a(n)[0] && (D *= -1, e *= -2);
				n = G[B];
				if (Q.infiniteSlider) var K = p[B],
					z = A[B];
				H = [];
				t = [];
				for (var N = 0; N < y.length; N++) H[N] = y[N], N < c.length && (t[N] = m.getSliderOffset(a(c[N]), "x"));
				for (; 1 < e || -1 > e;) {
					e *= frictionCoefficient;
					h += e;
					(h > -1 * p[B] || h < -1 * A[B]) && !Q.infiniteSlider && (e *= elasticFrictionCoefficient, h += e);
					if (Q.infiniteSlider) {
						if (h <= -1 * z) {
							z = a(b).width();
							var I = 0,
								E = t[0];
							for (N = 0; N < t.length; N++) t[N] < E && (E = t[N], I = N);
							N = K + z;
							t[I] = N;
							K = -1 * H[1] + L;
							z = K + z - l;
							H.splice(0, 1);
							H.splice(H.length, 0, -1 * N + L);
							n++
						}
						if (h >= -1 * K) {
							z = a(b).width();
				...
				t = !1;
				e = m.calcActiveOffset(Q, h, H, l, n, C, F[B], B);
				K = (e + n + C) % C;
				Q.snapToChildren && (Q.infiniteSlider ? K != aa[B] && (t = !0) : e != F[B] && (t = !0), 0 > D && !t ? (e++, e >= y.length && !Q.infiniteSlider && (e = y.length - 1)) : 0 < D && !t && (e--, 0 > e && !Q.infiniteSlider && (e = 0)));
				if (Q.snapToChildren || (h > -1 * p[B] || h < -1 * A[B]) && !Q.infiniteSlider) {
					(h > -1 * p[B] || h < -1 * A[B]) && !Q.infiniteSlider ? k.splice(0, k.length) : (k.splice(.1 * k.length, k.length), h = 0 < k.length ? k[k.length - 1] : h);
					for (; h < H[e] - .5 || h > H[e] + .5;) h = (h - H[e]) * snapFrictionCoefficient + H[e], k[k.length] = h;
					k[k.length] = H[e]
				}
				D = 1;
				0 != k.length % 2 && (D = 0);
				...
				for (h = D; h < k.length; h += 2)
					if (h == D || 1 < Math.abs(k[h] - K) || h >= k.length - 2) K = k[h], d[d.length] = m.slowScrollHorizontalIntervalTimer(10 * h, b, c, k[h], f, g, l, r, u, x, e, O, y, q, C, v, B, L, n, Q);
				K = (e + G[B] + C) % C;
				"" != Q.onSlideComplete && 1 < k.length && (d[d.length] = m.onSlideCompleteTimer(10 * (h + 1), Q, b, a(b).children(":eq(" + K + ")"), n, B));
				d[d.length] = m.updateBackfaceVisibilityTimer(10 * (h + 1), c, B, C, Q);
				X[B] = d;
				m.hideScrollbar(Q, d, h, k, f, g, l, u, x, B)
			},
			...
			getSliderOffset: function(b, c) {
				c = "x" == c ? 4 : 5;
				if (!g || r || u) b = parseInt(a(b).css("left"), 10);
				else {
			...
			setBrowserInfo: function() {
				null != navigator.userAgent.match("WebKit") ? (C = "-webkit-grab", E = "-webkit-grabbing") : null != navigator.userAgent.match("Gecko") ? (x = !0, C = "move", E = "-moz-grabbing") : null != navigator.userAgent.match("MSIE 7") ? y = r = !0 : null != navigator.userAgent.match("MSIE 8") ? y = u = !0 : null != navigator.userAgent.match("MSIE 9") && (y = !0)
			},
			...
			changeSlide: function(b, c, d, e, f, g, l, r, u, x, p, y, C, v, B, q, E, n) {
				m.autoSlidePause(v);
				...
				if (n.infiniteSlider) {
					b = (b - G[v] + 2 * q) % q;
					h = !1;
					0 == b && 2 == q && (b = q, y[b] = y[b - 1] - a(d).eq(0).outerWidth(!0), h = !0);
					t = y[b];
					t -= k;
					var z = [y[b] - a(c).width(), y[b] + a(c).width()];
					h && y.splice(y.length - 1, 1);
					for (h = 0; h < z.length; h++) Math.abs(z[h] - k) < Math.abs(t) && (t = z[h] - k)
				}
				0 > t && -1 == K ? t += a(c).width() : 0 < t && 1 == K && (t -= a(c).width());
				K = [];
				m.showScrollbar(n, f);
				for (h = 0; h <= D; h++) z = h, z /= D, z--, z = k + t * (Math.pow(z, 5) + 1), K[K.length] = z;
				D = (b + G[v] + q) % q;
				for (h = k = 0; h < K.length; h++) {
					if (0 == h || 1 < Math.abs(K[h] - k) || h >= K.length - 2) k = K[h], e[h] = m.slowScrollHorizontalIntervalTimer(10 * (h + 1), c, d, K[h], f, g, l, r, u, x, b, p, y, B, q, C, v, E, D, n);
					0 == h && "" != n.onSlideStart && (t = (F[v] + G[v] + q) % q, n.onSlideStart(new m.args("start", n, c, a(c).children(":eq(" + t + ")"), t, b)))
				}
				k = !1;
				n.infiniteSlider ? D != aa[v] && (k = !0) : b != F[v] && (k = !0);
				k && "" != n.onSlideComplete && (e[e.length] = m.onSlideCompleteTimer(10 * (h + 1), n, c, a(c).children(":eq(" + D + ")"), D, v));
				X[v] = e;
				m.hideScrollbar(n, e, h, K, f, g, l, u, x, v);
				m.autoSlide(c, d, e, f, g, l, r, u, x, p, y, C, v, B, q, E, n)
			},
			changeOffset: function(b, c, d, e, f, g, l, r, u, y, x, C, E, v, B, q, R, n) {
				m.autoSlidePause(v);
				for (var h = 0; h < e.length; h++) clearTimeout(e[h]);
				n.infiniteSlider || (b = b > -1 * p[v] + R ? -1 * p[v] + R : b, b = b < -1 * A[v] ? -1 * A[v] : b);
				var k = Math.ceil(n.autoSlideTransTimer / 10) + 1,
					D = m.getSliderOffset(c, "x");
				h = (m.calcActiveOffset(n, b, C, l, G, q, F[v], v) + G[v] + q) % q;
				var t = C.slice();
				if (n.snapToChildren && !n.infiniteSlider) b = C[h];
					...
					h = m.calcActiveOffset(n, b, t, l, G, q, F[v], v);
					b = t[h]
				}
				var K = b - D;
				b = [];
				...
				for (t = 0; t <= k; t++) {
					...
					z /= k;
					z--;
					z = D + K * (Math.pow(z, 5) + 1);
					b[b.length] = z
				}
				k = (h + G[v] + q) % q;
				for (t = D = 0; t < b.length; t++) {
					if (0 == t || 1 < Math.abs(b[t] - D) || t >= b.length - 2) D = b[t], e[t] = m.slowScrollHorizontalIntervalTimer(10 * (t + 1), c, d, b[t], f, g, l, r, u, y, h, x, C, B, q, E, v, R, k, n);
					0 == t && "" != n.onSlideStart && (k = (F[v] + G[v] + q) % q, n.onSlideStart(new m.args("start", n, c, a(c).children(":eq(" + k + ")"), k, h)))
				}
				D = !1;
				n.infiniteSlider ? k != aa[v] && (D = !0) : h != F[v] && (D = !0);
				D && "" != n.onSlideComplete && (e[e.length] = m.onSlideCompleteTimer(10 * (t + 1), n, c, a(c).children(":eq(" + k + ")"), k, v));
				X[v] = e;
				m.hideScrollbar(n, e, t, b, f, g, l, u, y, v);
				m.autoSlide(c, d, e, f, g, l, r, u, y, x, C, E, v, B, q, R, n)
			},
			autoSlide: function(a, b, c, d, e, f, g, l, r, u, y, x, p, v, C, q, E) {
				if (!V[p].autoSlide) return !1;
				m.autoSlidePause(p);
				R[p] = setTimeout(function() {
					!E.infiniteSlider && F[p] > y.length - 1 && (F[p] -= C);
					m.changeSlide(F[p] + G[p] + 1, a, b, c, d, e, f, g, l, r, u, y, x, p, v, C, q, E);
					m.autoSlide(a, b, c, d, e, f, g, l, r, u, y, x, p, v, C, q, E)
			...
			slowScrollHorizontalIntervalTimer: function(a, b, c, d, e, f, g, l, r, u, y, p, x, v, C, q, E, n, A, F) {
				return setTimeout(function() {
					m.slowScrollHorizontalInterval(b, c, d, e, f, g, l, r, u, y, p, x, v, C, q, E, n, A, F)
				}, a)
			},
			...
			hideScrollbarIntervalTimer: function(a, b, c, d, e, f, g, l, r, u) {
				return setTimeout(function() {
					m.hideScrollbarInterval(b, c, d, e, f, g, l, r, u)
				}, a)
			},
			...
			updateBackfaceVisibility: function(b, c, d, e) {
				...
				for (var h = [], f = 0; f < 2 * e.hardwareAccelBuffer; f++) {
					...
					if ("visible" == a(b).eq(g).css("-webkit-backface-visibility")) {
						...
						a(b).eq(g).css("-webkit-backface-visibility", "hidden"); - 1 == h.indexOf(l) && a(b).eq(l).css("-webkit-backface-visibility", ""); - 1 == h.indexOf(D) && a(b).eq(D).css("-webkit-backface-visibility", "")
					}
				}
			},
			mod: function(a, b) {
		...
		init: function(K, z) {
			...
			return a(z).each(function(g) {
				function D() {
					...
					q = a(H).parent().width();
					L = a(H).outerWidth(!0);
					h.responsiveSlideContainer && (L = a(H).outerWidth(!0) > q ? q : a(H).width());
					a(H).css({
					...
					for (var b = 0; b < J.length; b++) {
						...
						var c = T[b];
						h.responsiveSlides && (T[b] > L ? (c = L + -1 * (T[b] - ma[b]), ma[b] = c, T[b] = L) : c = ma[b], a(J[b]).css({
							width: c
						}));
						a(J[b]).css({
							overflow: "hidden",
					...
					h.snapSlideCenter && (n = .5 * (L - T[0]), h.responsiveSlides && T[0] > L && (n = 0));
					ba[k] = 2 * A[k];
					for (b = 0; b < J.length; b++) m.setSliderOffset(a(J[b]), -1 * w[b] + A[k] + n), w[b] -= A[k];
					if (!h.infiniteSlider && !h.snapSlideCenter) {
						for (b = 0; b < w.length && !(w[b] <= -1 * (2 * A[k] - L)); b++) Da = b;
						w.splice(Da + 1, w.length);
						w[w.length] = -1 * (2 * A[k] - L)
					}
					...
					ua = a(H).parent().outerHeight(!0);
					Q = a(H).height();
					h.responsiveSlideContainer && (Q = Q > ua ? ua : Q);
					a(H).css({
						height: Q
					});
					m.setSliderOffset(M, w[F[k]]);
					if (h.infiniteSlider && !fa) {
						...
						for (; b <= -1 * A[k];) d = 0, e = m.getSliderOffset(a(J[0]), "x"), a(J).each(function(a) {
							m.getSliderOffset(this, "x") < e && (e = m.getSliderOffset(this, "x"), d = a)
						}), f = p[k] + ea, m.setSliderOffset(a(J)[d], f), p[k] = -1 * w[1] + n, A[k] = p[k] + ea - L, w.splice(0, 1), w.splice(w.length, 0, -1 * f + n), G[k]++, F[k]--
					}
					m.setSliderOffset(M, w[F[k]]);
					...
					}), U = parseInt(a("." + R).css("marginLeft")) + parseInt(a("." + R).css("marginRight")), W = parseInt(a("." + R + " ." + I).css("borderLeftWidth"), 10) + parseInt(a("." + R + " ." + I).css("borderRightWidth"), 10), v = "" != h.scrollbarContainer ? a(h.scrollbarContainer).width() : L, B = L / ea * (v - U), h.scrollbarHide || (wa = h.scrollbarOpacity), a("." + R).css({
						position: "absolute",
						left: 0,
						width: v - U + "px",
						margin: h.scrollbarMargin
					}), "top" == h.scrollbarLocation ? a("." + R).css("top", "0") : a("." + R).css("bottom", "0"), a("." + R + " ." + I).css({
					...
					}), m.setSliderOffset(a("." + R + " ." + I), Math.floor((-1 * w[F[k]] - p[k] + n) / (A[k] - p[k] + n) * (v - U - B))), a("." + R).css({
						display: "block"
					}), O = a("." + R + " ." + I), S = a("." + R));
					h.scrollbarDrag && !fa && a("." + R + " ." + I).css({
						cursor: C
					});
					h.infiniteSlider && (Z = (A[k] + L) / 3);
					"" != h.navSlideSelector && a(h.navSlideSelector).each(function(b) {
						...
						a(this).unbind(da).bind(da, function(c) {
							...
							m.changeSlide(b, M, J, z, I, B, L, v, U, W, Y, w, T, k, Z, P, n, h)
						})
					});
					"" != h.navPrevSelector && (a(h.navPrevSelector).css({
						...
						b = (F[k] + G[k] + P) % P;
						(0 < b || h.infiniteSlider) && m.changeSlide(b - 1, M, J, z, I, B, L, v, U, W, Y, w, T, k, Z, P, n, h)
					}));
					"" != h.navNextSelector && (a(h.navNextSelector).css({
						...
						da = b.type + ".iosSliderEvent";
						b = (F[k] + G[k] + P) % P;
						(b < w.length - 1 || h.infiniteSlider) && m.changeSlide(b + 1, M, J, z, I, B, L, v, U, W, Y, w, T, k, Z, P, n, h)
					}));
					h.autoSlide && !fa && "" != h.autoSlideToggleSelector && (a(h.autoSlideToggleSelector).css({
						...
						"touchstart" == b.type ? a(this).unbind("click.iosSliderEvent") : a(this).unbind("touchstart.iosSliderEvent");
						da = b.type + ".iosSliderEvent";
						oa ? (m.autoSlide(M, J, z, I, B, L, v, U, W, Y, w, T, k, Z, P, n, h), oa = !1, a(h.autoSlideToggleSelector).removeClass("on")) : (m.autoSlidePause(k), oa = !0, a(h.autoSlideToggleSelector).addClass("on"))
					}));
					m.autoSlide(M, J, z, I, B, L, v, U, W, Y, w, T, k, Z, P, n, h);
				...
				var w, Y = [],
					...
					J, ma, T, P = a(M).children().not("script").length,
					ha = !1,
					Da = 0,
					ya = !1,
					ra = void 0,
				...
				h.scrollbar && ("" != h.scrollbarContainer ? a(h.scrollbarContainer).append("<div class = '" + R + "'><div class = '" + I + "'></div></div>") : a(M).parent().append("<div class = '" + R + "'><div class = '" + I + "'></div></div>"));
				if (!D()) return !0;
				a(this).find("a").bind("mousedown", m.preventDrag);
				a(this).find("[onclick]").bind("click", m.preventDrag).each(function() {
					a(this).data("onclick", this.onclick)
				});
				g = m.calcActiveOffset(h, m.getSliderOffset(a(M), "x"), w, L, G[k], P, void 0, k);
				g = (g + G[k] + P) % P;
				g = new m.args("load", h, M, a(M).children(":eq(" + g + ")"), g, g);
				a(H).data("args", g);
				if ("" != h.onSliderLoaded) h.onSliderLoaded(g);
				h.scrollbarPaging && h.scrollbar && !fa && (a(S).css("cursor", "pointer"), a(S).bind("click.iosSliderEvent", function(b) {
					this == b.target && (b.pageX > a(O).offset().left ? ca.nextPage(H) : ca.prevPage(H))
				}));
				if (V[k].responsiveSlides || V[k].responsiveSlideContainer) g = l ? "orientationchange" : "resize", a(window).bind(g + ".iosSliderEvent-" + k, function() {
					if (!D()) return !0;
					var b = a(H).data("args");
				...
				!h.keyboardControls && !h.tabToAdvance || fa || a(document).bind("keydown.iosSliderEvent", function(a) {
					r || u || (a = a.originalEvent);
					if ("INPUT" == a.target.nodeName || ia[k]) return !0;
					if (37 == a.keyCode && h.keyboardControls) a.preventDefault(), a = (F[k] + G[k] + P) % P, (0 < a || h.infiniteSlider) && m.changeSlide(a - 1, M, J, z, I, B, L, v, U, W, Y, w, T, k, Z, P, n, h);
					else if (39 == a.keyCode && h.keyboardControls || 9 == a.keyCode && h.tabToAdvance) a.preventDefault(),
						a = (F[k] + G[k] + P) % P, (a < w.length - 1 || h.infiniteSlider) && m.changeSlide(a + 1, M, J, z, I, B, L, v, U, W, Y, w, T, k, Z, P, n, h)
				});
				if (e || h.desktopClickDrag) {
					...
					var ta = a(M),
						Aa = !1;
					h.scrollbarDrag && (g = g.add(O), ta = ta.add(S));
					a(g).bind("mousedown.iosSliderEvent touchstart.iosSliderEvent", function(b) {
						...
						ka = a(this)[0] === a(O)[0] ? O : M;
						r || u || (b = b.originalEvent);
						m.autoSlidePause(k);
						...
						b > -1 * p[k] + n + ea ? (b = -1 * p[k] + n + ea, m.setSliderOffset(a("." + I), b), a("." + I).css({
							width: B - W + "px"
						})) : b < -1 * A[k] && (b = -1 * A[k], m.setSliderOffset(a("." + I), v - U - B), a("." + I).css({
							width: B - W + "px"
						}));
						b = a(this)[0] === a(O)[0] ? p[k] : 0;
					...
					a(document).bind("touchmove.iosSliderEvent mousemove.iosSliderEvent", function(b) {
						...
						if ("touchmove" == b.type) eventX = b.touches[0].pageX, eventY = b.touches[0].pageY;
							...
							eventX = b.pageX;
							eventY = b.pageY;
							if (!ya || !y && ("undefined" != typeof b.webkitMovementX || "undefined" != typeof b.webkitMovementY) && 0 === b.webkitMovementY && 0 === b.webkitMovementX) return !0
						}
						K[0] = K[1];
						K[1] = eventX;
						c = (K[1] - K[0]) / 2;
						...
						if (ha && !sa) {
							...
							var D = a(ka)[0] === a(O)[0] ? p[k] : n,
								l = a(ka)[0] === a(O)[0] ? (p[k] - A[k] - n) / (v - U - B) : 1,
								t = a(ka)[0] === a(O)[0] ? h.scrollbarElasticPullResistance : h.elasticPullResistance,
								z = h.snapSlideCenter && a(ka)[0] === a(O)[0] ? 0 : n,
								q = h.snapSlideCenter && a(ka)[0] === a(O)[0] ? n : 0;
							...
							if (h.infiniteSlider) {
								if (g <= -1 * A[k]) {
									...
									if (g <= -1 * ba[k]) {
										...
										var E = 0,
											R = m.getSliderOffset(a(J[0]), "x");
										a(J).each(function(a) {
											m.getSliderOffset(this, "x") < R && (R = m.getSliderOffset(this, "x"), E = a)
										});
										t = p[k] + N;
										m.setSliderOffset(a(J)[E], t);
										p[k] = -1 * w[1] + n;
										A[k] = p[k] + N - L;
										w.splice(0, 1);
										w.splice(w.length, 0, -1 * t + n);
										G[k]++
									}
								}
								if (g >= -1 * p[k] || 0 <= g)
									if (N = a(M).width(), 0 <= g)
										for (C = -1 * Y[0], a(J).each(function(b) {
												m.setSliderOffset(a(J)[b], C + n);
												b < w.length && (w[b] = -1 * C);
												C += T[b]
											}), ja += -1 * w[0], p[k] = -1 * w[0] + n, A[k] = p[k] + N - L, G[k] = P; 0 < -1 * w[0] - N + n;) {
											var S = 0,
												Q = m.getSliderOffset(a(J[0]), "x");
											a(J).each(function(a) {
												m.getSliderOffset(this, "x") > Q && (Q = m.getSliderOffset(this, "x"), S = a)
											});
											t = p[k] - T[S];
											m.setSliderOffset(a(J)[S], t);
											w.splice(0, 0, -1 * t + n);
											w.splice(w.length - 1, 1);
											p[k] = -1 * w[0] + n;
											A[k] = p[k] + N - L;
											G[k]--;
											F[k]++
										} else S = 0, Q = m.getSliderOffset(a(J[0]), "x"), a(J).each(function(a) {
											m.getSliderOffset(this, "x") > Q && (Q = m.getSliderOffset(this, "x"), S = a)
										}), t = p[k] - T[S], m.setSliderOffset(a(J)[S], t), w.splice(0, 0, -1 * t + n), w.splice(w.length - 1, 1), p[k] = -1 * w[0] + n, A[k] = p[k] + N - L, G[k]--
							} else N = a(M).width(), g > -1 * p[k] + n && (e = (p[k] + -1 * (ja - D - eventX + z) * l - D) * t * -1 / l), g < -1 * A[k] && (e = (A[k] + q + -1 * (ja - D - eventX) * l - D) * t * -1 / l);
							m.setSliderOffset(M, -1 * (ja - D - eventX - e) * l - D + q);
							h.scrollbar && (m.showScrollbar(h, I), f = Math.floor((ja - eventX - e - p[k] + z) / (A[k] - p[k] + n) * (v - U - B) * l), g = B, 0 >= f ? (g = B - W - -1 * f, m.setSliderOffset(a("." + I), 0), a("." + I).css({
								width: g + "px"
							})) : f >= v - U - W - B ? (g = v - U - W - f, m.setSliderOffset(a("." + I), f), a("." + I).css({
								width: g + "px"
							})) : m.setSliderOffset(a("." + I), f));
							"touchmove" == b.type && (Ba = b.touches[0].pageX);
							b = !1;
							e = m.calcActiveOffset(h, -1 * (ja - eventX - e), w, L, G[k], P, void 0, k);
							g = (e + G[k] + P) % P;
							h.infiniteSlider ? g != aa[k] && (b = !0) : e != F[k] && (b = !0);
							if (b) {
								F[k] = e;
								aa[k] = g;
								pa = !0;
					...
					a(g).bind("touchcancel.iosSliderEvent touchend.iosSliderEvent", function(a) {
						...
						if (0 != a.touches.length)
							for (var b = 0; b < a.touches.length; b++) a.touches[b].pageX == Ba && m.slowScrollHorizontal(M, J, z, I, c, d, B, L, v, U, W, Y, w, T, k, Z, P, ka, pa, n, h);
						else m.slowScrollHorizontal(M, J, z, I, c, d, B, L, v, U, W, Y, w, T, k, Z, P, ka, pa, n, h);
						la = sa = !1;
						return !0
					});
					a(Ga).bind("mouseup.iosSliderEvent-" + k, function(b) {
						...
						if (!na[k]) {
							...
							m.slowScrollHorizontal(ra, J, z, I, c, d, B, L, v, U, W, Y, w, T, k, Z, P, ka, pa, n, h);
							ra = void 0
						}
						la = sa = !1
					})
...
(function(a) {
	...
	r.prototype = {
		...
		open: function(c) {
			...
			}), l += " mfp-close-btn-in") : b.wrap.append(R()));
			...
			g = b.st.mainClass;
			return b.isIE7 && (g += " mfp-ie7"), g && b._addClassToMFP(g), b.updateItemHTML(), E("BuildControls"), a("html").css(h), b.bgOverlay.add(b.wrap).prependTo(b.st.prependTo || d), b._lastFocusedEl = document.activeElement,
				setTimeout(function() {
					b.content ? (b._addClassToMFP("mfp-ready"), b._setFocus()) : b.bgOverlay.addClass("mfp-ready");
					f.on("focusin.mfp", b._onFocusIn)
				}, 16), b.isOpen = !0, b.updateSize(e), E("Open"), c
		},
		close: function() {
			b.isOpen && (E("BeforeClose"), b.isOpen = !1, b.st.removalDelay && !b.isLowIE && b.supportsTransition ? (b._addClassToMFP("mfp-removing"), setTimeout(function() {
				b._close()
		...
		updateSize: function(a) {
			b.isIOS ? (a = document.documentElement.clientWidth / window.innerWidth * window.innerHeight, b.wrap.css("height", a), b.wH = a) : b.wH = a || y.height();
		...
		updateItemHTML: function() {
			...
			var d = c.type;
			if (E("BeforeChange", [b.currItem ? b.currItem.type : "", d]), b.currItem = c, !b.currTemplate[d]) {
				var f = b.st[d] ? b.st[d].markup : !1;
				E("FirstMarkupParse", f);
		...
		appendContent: function(a, c) {
			(b.content = a) ? b.st.showCloseBtn && b.st.closeBtnInside && !0 === b.currTemplate[c] ? b.content.find(".mfp-close").length || b.content.append(R()) : b.content = a: b.content = "";
			E("BeforeAppend");
		...
		updateStatus: function(a, d) {
			b.preloader && (c !== a && b.container.removeClass("mfp-s-" + c), d || "loading" !== a || (d = b.st.tLoading), d = {
				status: a,
				text: d
			}, E("UpdateStatus", d), a = d.status, d = d.text, b.preloader.html(d), b.preloader.find("a").on("click", function(a) {
				a.stopImmediatePropagation()
		...
		_hasScrollBar: function(a) {
			return (b.isIE7 ? f.height() : document.body.scrollHeight) > (a || y.height())
		},
		_setFocus: function() {
			...
			getInline: function(c, d) {
				if (G(), c.src) {
					...
					if (e.length) {
						...
						f && f.tagName && (F || (X = d.hiddenClass, F = C(X), X = "mfp-" + X), aa = e.after(F).detach().removeClass(X));
	...
	a.magnificPopup.registerModule("image", {
		...
		proto: {
			...
			_onImageHasSize: function(a) {
				a.img && (a.hasSize = !0, ba && clearInterval(ba), a.isCheckingImgSize = !1, E("ImageHasSize", a), a.imgHidden && (b.content && b.content.removeClass("mfp-loading"), a.imgHidden = !1))
			},
			...
			getImage: function(c, d) {
				var e = 0,
					f = function() {
						c && (c.img[0].complete ? (c.img.off(".mfploader"), c === b.currItem && (b._onImageHasSize(c), b.updateStatus("ready")), c.hasSize = !0, c.loaded = !0, E("ImageLoadComplete")) : (e++, 200 > e ? setTimeout(f, 100) : g()))
					},
					g = function() {
		...
		proto: {
			initGallery: function() {
				...
				return b.direction = !0, c && c.enabled ? (l += " mfp-gallery", x("Open.mfp-gallery", function() {
					...
					c.text && (c.text = z(c.text, b.currItem.index, b.items.length))
				}), x("MarkupParse.mfp-gallery", function(a, d, e, f) {
					a = b.items.length;
					e.counter = 1 < a ? z(c.tCounter, f.index, a) : ""
	...
	(function() {
			...
			return a(this).each(function() {
				...
				if (b) {
					...
					g.on("touchstart" + d, function(a) {
						...
						h = r.clientX;
						k = r.clientY;
						y.on("touchmove" + d, function(a) {
							r = a.originalEvent ? a.originalEvent.touches : a.touches;
							u = r.length;
							r = r[0];
							(10 < Math.abs(r.clientX - h) || 10 < Math.abs(r.clientY - k)) && (m = !0, c())
						}).on("touchend" + d, function(a) {
							c();
							m || 1 < u || (f = !0, a.preventDefault(), clearTimeout(l), l = setTimeout(function() {
								f = !1
							}, 1E3), e())
						})
					})
		...
		a.fn.destroyMfpFastClick = function() {
			...
			b && y.off("touchmove" + d + " touchend" + d)
		}
	})();
	V()
...
(function(a, b, c) {
	...
	var g = "placeholder" in b.createElement("input"),
		r = "placeholder" in b.createElement("textarea"),
		u = c.fn,
		y = c.valHooks,
		x = c.propHooks;
	g && r ? (u = u.placeholder = function() {
		return this
	...
	}, g || (y.input = u, x.value = u), r || (y.textarea = u, x.value = u), c(function() {
		...
		_setHover: function(a, b) {
			if (tdDetect.isTouchDevice) jQuery(document).on("touchstart", "body", function(b) {
				...
				b.find(".menu-item").hover(function() {
							...
							if (jQuery.isEmptyObject(c)) b.addClass(tdMenu._openMenuClass), b.children("ul").show(), c = b;
								...
								if (b[0] !== c[0]) {
									...
									b.on("mousemove", function(e) {
										5 <= g ? (g = 0, y = tdMenu._getMouseAngleDirection(r, u, e.pageX, e.pageY), r = e.pageX, u = e.pageY) : (g++, 0 === r && 0 === u && (r = e.pageX, u = e.pageY));
										null !== y && (85 < y || -85 > y) && (a.parent().removeClass(tdMenu._openMenuClass), a.parent().children("ul").hide(), b.addClass(tdMenu._openMenuClass), b.children("ul").show(), b.off("mousemove"), clearTimeout(d), f = !0, c = b)
									})
								}
							}
					...
					else b.parent().hasClass("sf-menu") || b.parent().hasClass("top-header-menu") ? jQuery.isEmptyObject(c) || (u = r = g = 0, y = null, !0 === f && (f = !1, d = setTimeout(function() {
						a.parent().removeClass(tdMenu._openMenuClass);
						a.parent().children("ul").hide();
						c = {}
					}, 400)), b.on("mousemove", function(e) {
						5 <= g ? (g = 0, y = tdMenu._getMouseAngleDirection(r, u, e.pageX, e.pageY), r = e.pageX, u = e.pageY) : (g++, 0 === r && 0 === u && (r = e.pageX, u = e.pageY));
						null !== y && (85 < y || -85 > y) && (a.parent().removeClass(tdMenu._openMenuClass), a.parent().children("ul").hide(), b.off("mousemove"), clearTimeout(d), f = !0, c = {})
...
function td_smart_lists_magnific_popup() {
	...
	jQuery("[data-mfp-src]").on("click", function(a) {
		a.preventDefault();
		if ("undefined" === typeof window.parent.tdcAdminSettings) return a = jQuery(this), a.hasClass("td-mfp-loaded") || (a.addClass("td-mfp-loaded"), a.magnificPopup({
			preloader: !0,
...
function td_scroll_to_class() {
	jQuery("[data-scroll-to-class]").on("click", function(a) {
		...
		if ("undefined" !== typeof d && "" !== d) {
			...
			}, 500) : td_helper_scroll_to_class(b, e, c, a, f, d)
		}
	})
}
...
function td_helper_scroll_to_class(a, b, c, d, f, e) {
	b.length ? (b = b.offset(), c = 400 * Math.floor(Math.abs(c.top - b.top) / 100), 1500 < c ? c = 1500 : 500 > c && (c = 500), tdUtil.scrollToPosition(b.top + d, c), a = a.parent().parent("li.menu-item"), a.length && (a.siblings(".current-menu-item").removeClass("current-menu-item"), a.addClass("current-menu-item")), jQuery("body").removeClass("td-menu-mob-open-menu")) : "undefined" !== typeof f && "" !== f && (td_set_cookies_life(["td-cookie-scroll-to-class", e, 864E5]), td_set_cookies_life(["td-cookie-scroll-offset", d,
		864E5
	]), jQuery("body").removeClass("td-menu-mob-open-menu"), window.location = f)
}
jQuery(window).on("load", function() {
...
jQuery().ready(function() {
	...
	void 0 !== window.tdb_login_sing_in_shortcode && (window.self === window.top && jQuery(".tdb_header_user .td-login-modal-js").magnificPopup(a), jQuery(".tdb-head-usr-log").on("click", function(a) {
	...
	tdDemoMenu = {
		...
		init: function() {
			...
			a(".td-set-theme-style-link").hover(function(b) {
				...
				0 === a(".td-set-theme-style-link").index(this) % 2 ? l = 2 * f.outerWidth(!0) : (f = f.prev(".td-set-theme-style"), f.length && (l = f.outerWidth(!0) - 0, g = f.outerWidth(!0) + 0), b.preventDefault(), b.stopPropagation());
				...
				if (!1 === tdSmartSidebar.is_enabled) {
					...
					for (var l = 0; l < tdSmartSidebar.items.length; l++) {
						...
						if (g.content_height <= g.sidebar_height) g.sidebar_state = "case_6_content_too_small";
							...
							var r = g.content_top;
							tdAffix.is_menu_affix || "undefined" === typeof window.tdThemeName || "Newsmag" !== window.tdThemeName || "smart_snap_always" !== tdAffix.tds_snap_menu || (r += b);
							tdSmartSidebar._is_smaller_or_equal(a, r) ? g.sidebar_state = "case_2_top_of_content" : !0 === tdSmartSidebar._is_smaller(g.sidebar_bottom, a) ? tdSmartSidebar._is_smaller(a, g.content_bottom - g.sidebar_height) ? g.sidebar_state = "case_4_fixed_up" : g.sidebar_state = "case_3_bottom_of_content" : tdSmartSidebar._is_smaller_or_equal(g.content_bottom, g.sidebar_bottom) ? "up" === d && tdSmartSidebar._is_smaller_or_equal(a, g.sidebar_top) ? g.sidebar_state = "case_4_fixed_up" : g.sidebar_state = "case_3_bottom_of_content" : g.sidebar_state = g.content_bottom - a >= g.sidebar_height ? "case_4_fixed_up" : "case_3_bottom_of_content"
						} else if (!0 === tdSmartSidebar._is_smaller(g.sidebar_bottom, a) ? !0 === tdSmartSidebar._is_smaller_or_equal(a, g.sidebar_top) && !0 === tdSmartSidebar._is_smaller_or_equal(g.content_top, a) ? g.sidebar_state = "case_4_fixed_up" : !0 === tdSmartSidebar._is_smaller(g.sidebar_bottom, e) && !0 === tdSmartSidebar._is_smaller(g.sidebar_bottom, g.content_bottom) && g.content_bottom >= e ? g.sidebar_state = "case_1_fixed_down" : g.sidebar_state = "case_3_bottom_of_content" : !0 === tdSmartSidebar._is_smaller(g.sidebar_bottom, e) && !0 === tdSmartSidebar._is_smaller(g.sidebar_bottom, g.content_bottom) && "down" === d && g.content_bottom >= e ? g.sidebar_state = "case_1_fixed_down" : !0 === tdSmartSidebar._is_smaller_or_equal(g.sidebar_top, g.content_top) && "up" === d && g.content_bottom >= e ? g.sidebar_state = "case_2_top_of_content" : !0 === tdSmartSidebar._is_smaller_or_equal(g.content_bottom, g.sidebar_bottom) && "down" === d || g.content_bottom < e ? g.sidebar_state = "case_3_bottom_of_content" : !0 === tdSmartSidebar._is_smaller_or_equal(a, g.sidebar_top) && "up" === d && !0 === tdSmartSidebar._is_smaller_or_equal(g.content_top, a) ? g.sidebar_state = "case_4_fixed_up" : "up" === d && !0 === tdSmartSidebar._is_smaller_or_equal(e, g.sidebar_top) && (g.sidebar_state = "case_2_top_of_content"), "case_1_fixed_down" === g.sidebar_state && "up" === d || "case_4_fixed_up" === g.sidebar_state && "down" === d) g.sidebar_state = "case_5_absolute";
						r = 0;
						null !== tdViewport.getCurrentIntervalItem() && (r = g.sidebar_jquery_obj.parent(".vc_column, .td-main-sidebar, .vc_column-inner, .vc_column_inner").width(), g.sidebar_jquery_obj.width(r));
	...
	tdYoutubePlayers = {
		...
		init: function() {
			for (var a = jQuery(".td_wrapper_playlist_player_youtube"), b = 0; b < a.length; b++) {
				...
				for (var e = c.parent().find(".td_click_video_youtube"), l = 0; l < e.length; l++) jQuery(e[l]).data("player-id", f), l + 1 < e.length ? jQuery(e[l]).data("next-video-id", jQuery(e[l + 1]).data("video-id")) : jQuery(e[l]).data("next-video-id", jQuery(e[0]).data("video-id"));
					...
					for (f = 0; f < d.settings.length; f++) {
						...
						if (e.start_percent <= a.percent_value && a.percent_value < e.end_percent || a.percent_value === e.end_percent && 100 === a.percent_value) {
							if (e.start_value === e.end_value) e = e.start_value;
								...
								e = e.start_value < e.end_value ? e.start_value + 1E3 * jQuery.easing[e.easing](null, f, 0, l, e.end_value - e.start_value) : e.start_value - 1E3 * jQuery.easing[e.easing](null, -f, 0, l, e.start_value - e.end_value)
							}
				...
				!0 === d ? (tdAnimationStack.log("%c live load items ", "background: brown; color: white;"), tdAnimationStack._precompute_items(f, b, c), tdAnimationStack.compute_items(d)) : (tdAnimationStack.log("%c preload items ", "background: brown; color: white;"), function() {
					...
					if (!1 === a) {
						...
						var u = setInterval(function() {
							var d;
							if ((new Date).getTime() - r > tdAnimationStack.max_waiting_for_init)
				...
				case "image_tag":
					...
					var c = (new Date).getTime(),
						d = setInterval(function() {
							var b = new Date;
							!0 === a.jqueryObj.data("complete") ? (clearInterval(d), a.jqueryObj.removeClass(tdAnimationStack._animation_css_class1), a.jqueryObj.addClass(tdAnimationStack._animation_css_class2)) : b.getTime() - c > tdAnimationStack.max_waiting_for_init && (clearInterval(d), a.jqueryObj.removeClass(tdAnimationStack._animation_css_class1), a.jqueryObj.addClass(tdAnimationStack._animation_css_class2))
						}, 100);
					break;
				case "css_image":
					a.jqueryObj.data("complete", !1);
					tdAnimationStack.log("%c image tag ", "background: #3ded97; color: #fff;");
					if (void 0 !== a.itemImgRetinaSrc && !0 === tdAnimationStack._isHighDensity()) jQuery("<img/>").attr("src", a.itemImgRetinaSrc).on("load", function() {
						jQuery(this).remove();
						a.jqueryObj.data("complete", !0)
					});
...
if ("enabled" == tdUtil.getBackendVar("tds_smart_sidebar") && !1 === tdDetect.isIos) jQuery(window).on("load", function() {
	...
	jQuery(".vc_row").each(function() {
		var a = [],
			c;
		jQuery(this).children(".vc_column").each(function(b, f) {
			b = jQuery(f);
			if (b.hasClass("td-is-sticky")) a.push(b.find(".wpb_wrapper:first"));
			else if ("undefined" === typeof c || c.outerHeight(!0) < b.outerHeight(!0)) c = b.find(".wpb_wrapper:first")
		});
...
jQuery(window).ready(function() {
	jQuery(".td-category-siblings").each(function(a, b) {
		b = jQuery(b);
		a = b.find(".td-category:first");
		b = b.find(".td-subcat-dropdown:first");
		if (1 == a.length && 1 == b.length) {
			var c = new tdPullDown.item;
			c.horizontal_jquery_obj = a;
			c.vertical_jquery_obj = b;
			c.horizontal_element_css_class = "entry-category";
			c.container_jquery_obj = a.parents(".td-category-siblings:first");
...
function td_compute_backstretch_item(a) {
	var b = 100 * (tdEvents.window_innerHeight - a.offset_top) / (tdEvents.window_innerHeight + a.full_height),
		c = a.offset_top / 2,
		d = -c / 2,
		f = 0 == d ? a.full_height / 6 : c / 1.2 * (100 - b) / (100 * tdEvents.window_innerHeight / (tdEvents.window_innerHeight + a.full_height) - b);
	d += .5;
	a.remove_item_property("move_y");
	a.add_item_property("move_y", b, 100, d, f, "");
	var e = parseFloat(1 + Math.abs(c) / a.full_height).toFixed(2);
